...
Dieser Spec-Node beschreibt die Anforderungen an den Software-Architekturprozess
gemäß ASPICE SWE.2. Der Normtext ist nicht abgedruckt (kommerzielle Lizenz).
...
**Rationale**: Der SDD-Workflow erfüllt SWE.2 durch:
